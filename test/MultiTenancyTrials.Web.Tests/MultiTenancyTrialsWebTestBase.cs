...
{
    public abstract class MultiTenancyTrialsWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static MultiTenancyTrialsWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(MultiTenancyTrialsWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<MultiTenancyTrialsDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<MultiTenancyTrialsDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<MultiTenancyTrialsDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<MultiTenancyTrialsDbContext, Task<T>> func)
        {
            T result;
